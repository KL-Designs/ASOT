                ...
                <>
                    <div className='mx-6 mt-4' style={{ borderBottom: '1px solid rgba(219,0,29,0.42)' }}>
                        ...
                        >
                            ...
                            {canManageMembers && (
                                <Tab label={<PinTabLabel label='ERA Options' pinLabel='J2 — ERA Options' href='/dashboard/j2' tabIndex={5} />} sx={tabSx} />
                            )}
                        </Tabs>
                    </div>
                    ...
                    <div className='flex-1 min-h-0 mt-0'>
                        ...
                        {tab === 5 && canManageMembers && <EraOptionsTab />}
                    </div>
                </>
            )}
        </div>
