...
export function CertificateViewer({
	...
	useEffect(() => {
		...
		// Stops the page scrolling behind a full-screen certificate.
	 ...
	 *
	 * `position: fixed` only means "relative to the viewport" while no
	 * ancestor establishes a containing block, and a transform does —
	 * including one merely filling from a finished animation. The profile's
	 * panels animate in with translateY, so a certificate opened from an
	 * awards or promotions row was being clipped to that panel: oversized,
	 * off-centre, with the page still visible around it.
	 */
	const overlay = (
			<div
