    ...
    const sections: NavSection[] = [
        {
            ...
            items: [
                {
                    label: '[J1] Recruitment', href: '/dashboard/j1', visible: permissions.canSeeJ1, icon: <PersonAdd sx={{ fontSize: 14 }} />,
                    tabs: [
                        ...
                        { label: 'Tickets',        tab: 5 },
                        ...(permissions.canManageJ1 ? [{ label: 'TFAR Plugin', tab: 6 }, { label: 'Recruit Video', tab: 7 }] : []),
                    ],
                },
                {
                    ...
                    tabs: [
                        ...
                        { label: 'Mission Checks',    tab: 4 },
                        { label: 'Intel Images',      tab: 5 },
                    ],
                },
                {
                ...
                },
                {
                    ...
                    tabs: [
                        ...
                        { label: 'Tools',            tab: 5 },
                        { label: 'AI Administration', tab: 6 },
                    ],
                },
                {
                    label: '[J5] Media', href: '/dashboard/j5', visible: permissions.canSeeJ5, icon: <Collections sx={{ fontSize: 14 }} />,
                    tabs: [
                        { label: 'Gallery',              tab: 0 },
                ...
                {
                    label: '[J6] Game Masters', href: '/dashboard/j6', visible: permissions.canSeeJ6, icon: <SportsEsports sx={{ fontSize: 14 }} />,
                    tabs: [
        ...
        },
        {
            label: 'Personnel',
            items: [
                { label: 'HQ Staff',    href: '/dashboard/personnel/hq-staff', visible: permissions.canSeePersonnel, icon: <Badge sx={{ fontSize: 14 }} /> },
                { label: 'All Staff',   href: '/dashboard/personnel/all-staff', visible: permissions.canSeePersonnel, icon: <Groups sx={{ fontSize: 14 }} /> },
                { label: 'Members',     href: '/dashboard/personnel/all',       visible: permissions.canSeePersonnel, icon: <People sx={{ fontSize: 14 }} /> },
            ],
        },
        {
            label: 'Unit',
            items: [
                ...
                { label: 'Training Hub',    href: '/dashboard/unit/training-hub',          visible: true,                    icon: <MenuBook sx={{ fontSize: 14 }} /> },
