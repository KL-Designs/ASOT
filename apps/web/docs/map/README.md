...
| Milpac generation (uniform/medal/certificate PNGs) | D (`/api/generate/milpac/[username]`, `/api/milpac/certificate/[username]`, `/api/milpacs/[name]`), H (`lib/milpac-gen/**` — rendering itself lives in `apps/milpac`) |
