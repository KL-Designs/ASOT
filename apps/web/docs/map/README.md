...
| HZN-MED medical minigame (easter egg: ACE/KAT parody, wounds, dressings, airway, drugs, rhythms) | G (`milpacs/[username]/medical-menu/**`) — one member only, gated in `milpac-file.tsx`; no API routes and nothing persisted |
