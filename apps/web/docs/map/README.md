...
| Department quick links (J1-J7 favicon tile rail, per-dept restricted tier, self-hosted favicons) | A (`/api/admin/dept-links/**`), E/F (`_components/dept-links/**`, `DeptSettingsView.tsx`, the J1-J7 panels' Settings view), H (`types/department-link.d.ts`, `lib/safe-fetch.ts`, `lib/dept-links/**`, `lib/orbat/hasPermissions.ts`) — design spec: `docs/superpowers/specs/2026-08-11-dept-quick-links-design.md` |
