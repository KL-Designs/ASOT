...
Rendered as `RolesManagerPanel`'s "Department Roles" tab. Currently a stub placeholder ("Coming soon.") — fully documented in a future task once the real implementation lands.
