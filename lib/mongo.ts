...
const DbInterface = {
    ...
    feedbackLegacy: client.db(process.env.MONGO_DB!).collection('feedback') as MongoCollection<Feedback>,
    feedbackLegacyComments: client.db(process.env.MONGO_DB!).collection('feedback_comments') as MongoCollection<FeedbackComment>,
    ...
    communityTicketsMigrationTarget: client.db(process.env.MONGO_DB!).collection('community_tickets') as MongoCollection<CommunityTicket>,
    communityTicketCommentsMigrationTarget: client.db(process.env.MONGO_DB!).collection('community_ticket_comments') as MongoCollection<CommunityTicketComment>,
