...
export const AWARDS = [
    ...
    { csvHeader: 'Campaign Medallion First Clasp',                label: 'Campaign Medallion, First Clasp',           type: 'Operational Service Citation', points: 10  },
    { csvHeader: 'Campaign Medallion Second Clasp',               label: 'Campaign Medallion, Second Clasp',          type: 'Operational Service Citation', points: 10  },
    { csvHeader: 'Campaign Medallion Third Clasp',                label: 'Campaign Medallion, Third Clasp',           type: 'Operational Service Citation', points: 15  },
    { csvHeader: 'Campaign Medallion Fourth Clasp',               label: 'Campaign Medallion, Fourth Clasp',          type: 'Operational Service Citation', points: 15  },
    { csvHeader: 'Campaign Medallion, Tier 2 First Clasp',        label: 'Campaign Medallion, Fifth Clasp',           type: 'Operational Service Citation', points: 20  },
    { csvHeader: 'Campagin Medallion, Tier 2 Second Clasp',       label: 'Campaign Medallion, Sixth Clasp',           type: 'Operational Service Citation', points: 20  },
    { csvHeader: 'Campagin Medallion, Tier 2 Third Clasp',        label: 'Campaign Medallion, Seventh Clasp',         type: 'Operational Service Citation', points: 20  },
    { csvHeader: 'Campagin Medallion, Tier 2 Fourth Clasp',       label: 'Campaign Medallion, Eighth Clasp',          type: 'Operational Service Citation', points: 20  },
    { csvHeader: 'Campagin Medallion, Tier 3 First Clasp',        label: 'Campaign Medallion, Ninth Clasp',           type: 'Operational Service Citation', points: 25  },
    { csvHeader: 'Campagin Medallion, Tier 3 Second Clasp',       label: 'Campaign Medallion, Tenth Clasp',           type: 'Operational Service Citation', points: 25  },
    { csvHeader: 'Campagin Medallion, Tier 3 Third Clasp',        label: 'Campaign Medallion, Eleventh Clasp',        type: 'Operational Service Citation', points: 25  },
    { csvHeader: 'Campagin Medallion, Tier 3 Fourth Clasp',       label: 'Campaign Medallion, Twelfth Clasp',         type: 'Operational Service Citation', points: 25  },
    { csvHeader: 'Campagin Medallion, Tier 4 First Clasp',        label: 'Campaign Medallion, Thirteenth Clasp',      type: 'Operational Service Citation', points: 25  },
    { csvHeader: 'Campagin Medallion, Tier 4 Second Clasp',       label: 'Campaign Medallion, Fourteenth Clasp',      type: 'Operational Service Citation', points: 25  },
    { csvHeader: 'Campagin Medallion, Tier 4 Third Clasp',        label: 'Campaign Medallion, Fifteenth Clasp',       type: 'Operational Service Citation', points: 25  },
    { csvHeader: 'Campagin Medallion, Tier 4 Fourth Clasp',       label: 'Campaign Medallion, Sixteenth Clasp',       type: 'Operational Service Citation', points: 25  },
